function binarizeAndIDvariants(spatialCorrMap,outputdir, subID, task, snrMask,corrThresh,sizeThresh)
...
neighLoc = '/Users/shefalirai/Desktop';
...
if ~exist('outputdir')
    outputdir = '/Users/shefalirai/Desktop';
end
...
ft_write_cifti_mod(sprintf([outputdir '/%s_%s_spatialVariants_thresh' num2str(variantThresh) '%_sizeThresh' num2str(sThresh) '.dtseries.nii'], subID, task), template);
